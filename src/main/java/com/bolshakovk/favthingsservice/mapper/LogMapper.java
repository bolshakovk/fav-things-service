...
//использовал май батис для загрузки логов в бд
@Mapper
public interface LogMapper {
    ...
    @Insert("INSERT INTO public.logs(log_date_time, level_info, logger, message, username) VALUES (#{logDateTime}, #{level}, #{logger}, #{message}, #{username});")
